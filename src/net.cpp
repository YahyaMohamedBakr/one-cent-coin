...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Onecentcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"1centall.pro", "176.58.96.39"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    //{"onecentcointools.com", "testnet-seed.onecentcointools.com"},
    //{"xurious.com", "testnet-seed.ltc.xurious.com"},
    //{"wemine-testnet.com", "dnsseed.wemine-testnet.com"},
   {"test.1centall.pro", "176.58.96.39"},    
   {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Onecentcoin is probably already running."), addrBind.ToString().c_str());
        else
